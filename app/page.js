...
import { Check, ChevronRight, Menu, X, Moon, Sun, ArrowRight, Star, Zap, Shield, Users, BarChart, Layers } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <main className="flex-1">
        ...
        {/* CTA Section */}
        {/* <section className="w-full flex justify-center items-center py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
